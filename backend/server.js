...
const updateAuctionProducts=require('./routes/uypdateAuctionProducts.js');
const deleteMyAuctionCollections=require('./routes/deleteMyAuctionCollection.js');
const StartAcution=require('./routes/StartAuctions.js')
...
app.use(updateAuctionProducts);
app.use(deleteMyAuctionCollections);
app.use(StartAcution);
// app.use(newsRoute);
// ******** Post Routes End*********** //
